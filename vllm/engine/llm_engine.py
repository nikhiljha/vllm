...
class LLMEngine:
    ...
    def get_prefix_logs(self):
        ...
        return {
            ...
            'util_gpu': div(util[PrefixLocation.GPU], (util[PrefixLocation.GPU] + evictions[PrefixLocation.GPU])),
            'util_cpu': div(util[PrefixLocation.CPU], (util[PrefixLocation.CPU] + evictions[PrefixLocation.CPU])),
            'util_disk': div(util[PrefixLocation.DISK], (util[PrefixLocation.DISK] + evictions[PrefixLocation.DISK])),
        }
